...
\begin{frame}
 Nous allons mintenant montrer comment utiliser l'arbre constuit via les données d'apprentissage pour prédire la valeur d'une des variable en fonction des autres.
